...
class ContactMailer extends Mailer
{
    ...
    public function sendPaymentConfirmation(Payment $payment, $refunded = 0)
    {
        ...
        $data = [
            ...
            'fromEmail' => 'michaelhamptondesign@yahoo.com',
            'isRefund' => $refunded > 0,
        ];
...
//        }
        ...
        $fromEmail = 'michaelhamptondesign@yahoo.com';
        if ($fromEmail && $invoice->customer->email) {
            $this->sendTo($invoice->customer->email, $fromEmail, $accountName, 'Payment made', '', $data);
        }
        //$account->loadLocalizationSettings();
    }
