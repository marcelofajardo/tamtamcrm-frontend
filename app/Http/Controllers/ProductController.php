...
class ProductController extends Controller
{
    ...
    {
        $products = (new ProductFilter($this->product_repo))->filter($request,
    ...
    public function getProductsForTask(int $task_id, string $status)
    {
        ...
        $products = (new OrderFilter($orderRepository))->getProductsForTask((new TaskRepository(new Task))->findTaskById($task_id), $status);
        return response()->json($products);
    }
